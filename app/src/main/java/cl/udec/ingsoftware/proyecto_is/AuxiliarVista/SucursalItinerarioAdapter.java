...
public class SucursalItinerarioAdapter extends RecyclerView.Adapter<SucursalItinerarioAdapter.SucursalItinerarioViewHolder>{
    ...
    @Override
    public SucursalItinerarioViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View statusContainer = inflater.inflate(R.layout.cardview_itinerario_sucursal, parent, false);

        return new SucursalItinerarioViewHolder(statusContainer);
    }
    ...
    public static class SucursalItinerarioViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public SucursalItinerarioViewHolder(View itemView) {
            super(itemView);
            mCardView = (CardView)itemView.findViewById(R.id.card_view_itinerariosucursal);
